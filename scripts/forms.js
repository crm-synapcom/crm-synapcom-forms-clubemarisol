$(document).ready(function() {
    ...
    $('#contact_submit').click(function(event){
        ...
        if(!$('input[name=gender_radio]:checked', '#contact-form').val() && validate.gender){
        ...
        var rest_data = {
            ...
            'whatsapp_optin': $('#contact_whats_checker').is(':checked'),
        ...
        $.ajax({
            url: 'https://subscribeformsbackend.azurewebsites.net/api/clube-marisol',
            type: 'POST',
            dataType: 'json',
